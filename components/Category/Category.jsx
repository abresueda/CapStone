...
function Category() {
    ...
    const handleAddCategory =() => {
        ...
        axios.post("https://natural-kim-abresuedaozmen-a60d14d6.koyeb.app/api/v1/categories", newCategory)
        .then((res) => {
            setUpdate(false);
            setNewCategory({
                name: "",
    ...
    const handleDeleteCategory=(e)=> {
        axios.delete("https://natural-kim-abresuedaozmen-a60d14d6.koyeb.app/api/v1/categories/" + e.target.id)
        .then((res) =>
        {
            setUpdate(false);
    ...
    const handleUpdateCategory=()=> {
        ...
        axios.put("https://natural-kim-abresuedaozmen-a60d14d6.koyeb.app/api/v1/categories/" + updateCategory.id, updateCategory)
        .then(()=> {
            setUpdate(false);
            setUpdateCategory({
                id: "",
